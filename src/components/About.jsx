    ...
    <PageLayout title="About Us" contentSize="wide">
      <div className="text-center">
        <div className="space-y-12 text-center">
          ...
          <div>
            <h2 className="text-2xl mb-2">Layout and Design</h2>
